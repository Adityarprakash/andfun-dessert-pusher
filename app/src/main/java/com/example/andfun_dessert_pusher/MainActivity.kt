...
import com.example.andfun_dessert_pusher.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onTopResumedActivityChanged(isTopResumedActivity: Boolean) {
        ...
        Timber.i("onResumedCalled")
    }

    override fun onPause() {
        super.onPause()
        Timber.i("onPausedCalled")
    }

    override fun onDestroy() {
        super.onDestroy()
        Timber.i("onDestroyedCalled")
    }
